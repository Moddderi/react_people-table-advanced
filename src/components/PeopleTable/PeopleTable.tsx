...
import { handleSort } from '../../helpTools/handleSort';
import { getSortIconClass } from '../../helpTools/getSortIconClass';
        ...
        <tr>
          <th>
            <span className="is-flex is-flex-wrap-nowrap">
              Name
              <SearchLink params={handleSort(SortCategory.name, searchParams)}>
                <span className="icon">
                  <i
          ...
          <th>
            <span className="is-flex is-flex-wrap-nowrap">
              ...
              <SearchLink params={handleSort(SortCategory.sex, searchParams)}>
                <span className="icon">
                  <i
                    className={getSortIconClass(SortCategory.sex, searchParams)}
                  />
                </span>
              </SearchLink>
            </span>
      ...
      <tbody>
        {!people.length || !filteredPeople.length ? (
          ...
          filteredPeople.map(person => (
            <PersonLink key={`${person.name}-${person.born}`} person={person} />
          ))
        )}
      </tbody>
    </table>
